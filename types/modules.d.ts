...
declare module "astro/runtime/server/index.js" {
  export function renderToString(result: any, component: any, props: any, slots: any): Promise<string>;
...
declare module "prosemirror-schema-list" {
  export function addListNodes(nodes: any, paragraph: string, block: string): any;
}
