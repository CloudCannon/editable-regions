 ...
 * client for hydration, and gray-matter depends on Node's `Buffer`.
 */
 ...
 * — better a failed prerender than a page that silently renders empty editable
 * regions.
 */
...
/**
 * Block regions must paint rendered markdown, not source — the editor shows the
 * stored value rendered, so an unrendered field would look like it changed the
 * moment it's focused.
 */
